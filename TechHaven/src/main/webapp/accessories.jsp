<%-- 
    ...
    Created on : Sep 9, 2024, 10:39:45 AM
...
<head>
    <meta charset="UTF-8">
    <title>TechHaven - Accessories</title>
    <style>
        html, body {
            height: 100%;
            margin: 0;
...
<body>
    ...
    <main>
        ...
        <div class="cards-container">
            <%
                // JDBC settings for connecting to the database
                ...
                try {
                    ...
                    // SQL query to get items in the 'Accessories' category
                    String sql = "SELECT id, name, description, price, image FROM Item WHERE category_id = (SELECT id FROM Category WHERE name = 'Accessories') LIMIT 8";
            ...
            <%
                    ...
                    // Close the database connections and statement
                    try {
                        if (rs != null) rs.close();
